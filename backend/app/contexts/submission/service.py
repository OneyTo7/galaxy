...
class SubmissionService:
    def __init__(self, sub_repo: SubmissionRepoProtocol, assignment_svc: AssignmentService) -> None:
    ...
    def submit(self, user_id: int, assignment_id: int, code: str, lang: str):
        ...
        results: list[CaseResult] = runner.run(code, lang, assignment.test_cases)
